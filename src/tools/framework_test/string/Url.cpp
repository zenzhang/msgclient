...
{
    {
    Url url("http://www.google.cn:80/search?hl=zh-CN&newwindow=1&rlz=1T4GGLL_zh-CNCN330CN330&q=1gsdg");
    ...
    {
    Url url("http://[fe80::9862:baf0:b101:507a%11]:8000/search?hl=zh-CN&newwindow=1&rlz=1T4GGLL_zh-CNCN330CN330&q=1gsdg");
    assert(url.protocol() == "http");
    assert(url.user() == "");
    assert(url.password() == "");
